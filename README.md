...
+ [Python](https://www.python.org/) unpopular in East Asia, because Asian languages [are tricky to type](http://stackoverflow.com/questions/14682933/chinese-and-japanese-character-support-in-python), but easier [Coffeescript](http://coffeescript.org/) or the made in japan [Ruby](https://www.ruby-lang.org/).
