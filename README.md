...
+ webooks or [epub](http://idpf.org/epub) are responsive (better for multiple screens or paper sizes) and trendy. [pdf](http://www.adobe.com/devnet/pdf.html) have fixed size.
...
+ [Atom](https://atom.io/) crashes a lot. But is getting better. Coolest design. [Developed by active Github volunteers](https://github.com/atom/atom). Hackable to the core!
